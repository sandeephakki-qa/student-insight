...
const SmartQueryV2 = (function(){
  ...
  function match(queryText, limit){
    ...
    const countQuery = detectNameCountQuery(qTokens);
    if(countQuery){
    ...
    const namedCandidates = currentMode()==="institution" ? findStudentCandidates(qTokens) : [];
    ...
    const namedStudent = namedCandidates.length ? namedCandidates[0].student : null;
