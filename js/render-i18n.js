...
const SR_STRINGS_EN={
  ...
  scholarship_reason_academic_below_min:"Academic average is below the minimum required",
  scholarship_reason_attendance_exceeds_floor:"Absences exceed the allowed limit",
  scholarship_reason_no_fail_violated:"Failed the no-fail requirement in one or more tests",
  scholarship_reason_income_data_missing:"Family income data missing",
  scholarship_reason_income_exceeds_max:"Family income exceeds the maximum allowed",
  scholarship_reason_category_not_eligible:"Category is not a reserved category under this scheme",
  scholarship_reason_meets_all_criteria:"Meets all criteria",
  ...
  // Repurposed for the per-criterion Result column only (see
  // criterionResultBadge() in scholarship-audit-detail.js) — "gentler than
  // Pass/Fail" feedback. The overall eligibility badge now reuses
  // scholarship_dashboard_status_eligible/not_eligible below instead.
  ...
  lang_locked_during_analysis:"Language is locked until you return to Home — analysis results aren't re-translated mid-review.",
