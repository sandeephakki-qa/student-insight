...
const SR_STRINGS_EN={
  ...
  sample_5_desc:"Individual mode example — a Class 3 and a Class 6 child in one workbook, switcher shows both by name.",
  ...
  sample_8_desc:"Compare Sections example (2 of 3) — same Class 7, same Subjects/Tests/Max Marks as Sample 7 & 9, different section.",
  sample_9_desc:"Compare Sections example (3 of 3) — same Class 7, same Subjects/Tests/Max Marks as Sample 7 & 8, different section.",
  ...
  compare_demo_run_together:"Run Samples 7, 8 & 9 together as one side-by-side section comparison.",
  ...
  setup_multi_child_hint:"If tracking more than one child, use one workbook per child, or add each as a separate row and re-export per child.",
  setup_goal:"Goal",
