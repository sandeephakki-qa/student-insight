...
function showSampleFiles(){
  ...
  const files=[
    ...
    {name:"Sample 16 — School with Scholarship Eligibility Data.xlsx",file:"Sample_16_For_School_Scholarship_Eligibility.xlsx",desc:srT("sample_16_desc"),mode:"Institution"}
  ];
