...
import { renderDataIssueBanner, srT } from '../../core/render-i18n.js';
import { APP, goStep, isNavLockedForSetupTabs, refreshLangLockUI, setLangLockUI, updateNavHomeOnlyState } from '../../core/state-nav.js';
...
export { _bucketCharts, _charts, _modalFocusTrap, _modalLastFocus, bucketHeatmapHtml, buildSparkPath, buildStudentDetailHtml, buildStudentHealthScoreHtml, buildStudentKpiBottomGridHtml, buildStudentKpiStripHtml, buildStudentKpiTopGridHtml, buildStudentScoreTableHtml, closeModal, configureChartDefaults, dbTabKeyNav, destroyBucketCharts, destroyCharts, downloadUpdatedSheet, filterStudents, getFilteredStudents, getScopedStudents, gsapModalEntrance, narrativeCard, openStudentModal, populateIndividualSwitcher, remarkCardsHtml, remarkToneBadgeHtml, renderBucketClassCharts, renderBucketStudentTrendChart, renderBucketSubjectDistChart, renderCharts, renderClassInsights, renderDashboard, renderFlagsTable, renderHeatmap, renderKPIs, renderStudentCards, renderSubjectCorrelation, renderWellbeingPanel, runSampleFile, saveNarrativeField, saveRemarkField, selectIndividualStudent, setFilter, showRemarksDirtyBanner, showSampleFiles, sortStudents, updateExportGate, updateRemarkCharCount };
