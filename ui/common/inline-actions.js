...
import { shareInsightAsImage } from '../../core/render-i18n.js';
...
(function(){
  ...
  function dispatch(action, arg, el, ev){
    switch(action){
      ...
      case 'switchScholarshipTab': import('../scholarship/scholarship-dashboard.js').then(m => m.switchScholarshipTab(arg)); break;
      case 'toggleScholarshipErrorGrid': import('../scholarship/scholarship-dashboard.js').then(m => m.toggleScholarshipErrorGrid()); break;
      case 'saveScholarshipEdits': import('../scholarship/scholarship-edit-grid.js').then(m => m.saveScholarshipEdits()); break;
      case 'openScholarshipStudentDetail': import('../scholarship/scholarship-dashboard.js').then(m => m.openScholarshipStudentDetail(arg)); break;
      case 'downloadScholarshipReport': import('../scholarship/scholarship-dashboard.js').then(m => m.downloadScholarshipReport()); break;
      case 'downloadScholarshipCertificates': import('../scholarship/scholarship-audit-detail.js').then(m => m.downloadScholarshipCertificates()); break;
      case 'downloadDebugLog': ev.preventDefault(); downloadDebugLog(); break;
      case 'exportComparisonReportPDF': import('../../bal/compare/compute-compare.js').then(m => m.exportComparisonReportPDF()); break;
      case 'exportSectionPDFs':
        import('../../bal/compare/compute-compare.js').then(m => m.exportSectionPDFs($('#export-section-select').val()));
        break;
      case 'exportAllSectionsPDFs': import('../../bal/compare/compute-compare.js').then(m => m.exportAllSectionsPDFs()); break;
      ...
      case 'removeHomeCompareFile': import('../../bal/compare/compute-compare.js').then(m => m.removeHomeCompareFile(arg)); break;
      case 'resetHomeImport': resetHomeImport(); break;
      case 'selectCompareSection': import('../../bal/compare/compute-compare.js').then(m => m.selectCompareSection(arg)); break;
      case 'openBucket': openBucket(arg); break;
      case 'selectCompareGroup': import('../../bal/compare/compute-compare.js').then(m => m.selectCompareGroup(arg)); break;
      case 'openCrossSectionCompare': import('../../bal/compare/compute-compare.js').then(m => m.renderCrossSectionComparePicker()); break;
      ...
      case 'generateAllPDFs': import('../../bal/export/export-pdf.js').then(m => m.generateAllPDFs()); break;
  ...
  function genericInputDispatch(action, arg, el){
    switch(action){
      ...
      case 'renameHomeCompareFile': import('../../bal/compare/compute-compare.js').then(m => m.renameHomeCompareFile(arg, el.value)); break;
  ...
  function genericChangeDispatch(action, arg, el){
    switch(action){
      ...
      case 'crossCompareStudentChange': import('../../bal/compare/compute-compare.js').then(m => m.renderCrossSectionCompareResult()); break;
